...
$projectDirPath = Join-Path -Path $repoRootPath -ChildPath "MKTAdobe"
...
$projectFilePath = Join-Path -Path $projectDirPath -ChildPath "MKT_Adobe.sln"  # Replace with the actual SSIS project file name (.sln or .dtproj)
